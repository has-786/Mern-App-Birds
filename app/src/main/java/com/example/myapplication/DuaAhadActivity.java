...
import static com.example.myapplication.DuaActivity.id;

import static com.example.myapplication.DuaActivity.etitle;
import static com.example.myapplication.DuaActivity.utitle;
import static com.example.myapplication.DuaActivity.etrans;
import static com.example.myapplication.DuaActivity.utrans;
import static com.example.myapplication.DuaActivity.uarab;
import static com.example.myapplication.DuaActivity.earab;
import static com.example.myapplication.DuaActivity.udesc;
import static com.example.myapplication.DuaActivity.edesc;
public class DuaAhadActivity extends AppCompatActivity {
...
public static int id1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dua_ahad);
        getSupportActionBar().setBackgroundDrawable(getDrawable(R.color.green));

        Intent intent = getIntent();
        id1= Integer.parseInt(intent.getStringExtra(DuaActivity.MSG));


        pos=id.indexOf(id1);

        getSupportActionBar().setTitle("Read Dua"); // for set actionbar title
    ...
    public void fab(View v) {
        ...
        try{
            intent.putExtra(Intent.EXTRA_TEXT, "http://thelasthope.site/ReadDua/"+s+"/"+id1+"");}
        catch (Exception e){}
