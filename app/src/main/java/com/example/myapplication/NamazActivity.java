...
public class NamazActivity extends AppCompatActivity {
    ...
    static  ArrayList<String> etitle=new ArrayList<>();
    static ArrayList<String> edesc=new ArrayList<>();
    static ArrayList<String> earab=new ArrayList<>();
    static ArrayList<String> uarab=new ArrayList<>();
    static ArrayList<String> etrans=new ArrayList<>();
    static ArrayList<String> utitle=new ArrayList<>();
    static ArrayList<String> udesc=new ArrayList<>();
    static ArrayList<String> utrans=new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edesc=new ArrayList<>();
        earab=new ArrayList<>();
        etrans=new ArrayList<>();
        utitle=new ArrayList<>();
        udesc=new ArrayList<>();
        uarab=new ArrayList<>();
        utrans=new ArrayList<>();
        id=new ArrayList<>();
        ...
        String d=intent.getStringExtra(NamazActivity.MSG);
        if(d!=null)
        {
            Intent intent1=new Intent(this,NamazAhadActivity.class);
            intent1.putExtra(NamazActivity.MSG,d);
        ...
        try{
            ...
            for(int i=0;i<etitle.size();i++)
            {
                ...
                if(x.equals("Sorry Not Available") || x.equals("Sorry Urdu Not Available"))utitle.set(i,"");
