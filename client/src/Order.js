...
class Order extends Component{
	constructor(props){
		super(props);
this.state={username:null,arr:[{_id:null,paymentMethod:null,timestamp:null , prods:[{name:null,price:null,quantity:null}]}],msg:null,position:null}; 
	}
    ...
    <div id='contain' class="container"   >
      <div class="row" >
	    ...
	    <div class="col-lg-4"  >		<br></br><br></br>
			<div class="row" >
				<div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3" style={{padding:"15px",border:"5px solid green",borderRadius:"10px",backgroundColor:"pink"}} >
		  		<br></br>

						<div class="features-icons-icon d-flex" >
						<div class="col-lg-3">	<center><button class='btn btn-warning'>ID</button></center></div><div class="col-lg-9" style={{border:"2px solid purple",backgroundColor:"cyan",padding:"5px",borderRadius:"10px"}}><center>{res._id}</center></div>
						...
						<div class="features-icons-icon d-flex">
							<div class="col-lg-12">	<button  class='btn btn-secondary'   style={{marginRight:"15px"}}>Birds</button></div>
							<br></br><br></br><br></br>
						</div>
...
<div class="features-icons-icon d-flex">
	...
	<div class="col-lg-9">	<button  class='btn btn-primary' >{prod.name}</button></div>
	<br></br><br></br>
