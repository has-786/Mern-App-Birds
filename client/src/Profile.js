...
<i class='fa fa-shopping-cart' style={{fontSize:"40px",color:"green"}}></i>            </div>
            <h3 ><a href="/Showcart">My Cart</a></h3>
            <p class="lead mb-0" style={{fontWeight:'bold'}}>Check What's in your cart</p>
          </div>
        </div>
		...
		<div class="col-lg-3">
          <div class="features-icons-item mx-auto mb-0 mb-lg-3">
            ...
            <p class="lead mb-0" style={{fontWeight:'bold'}}>Check Your Orders</p>
          </div>
        </div>
...
<i class='fa fa-video'  style={{fontSize:"40px",color:"red"}}></i>
            ...
            <h3 ><a href='/Likedvideos'> Liked Videos</a> </h3>
            <p class="lead mb-0" style={{fontWeight:'bold'}}>Your Liked Videos</p>
          </div>
        </div>
...
<i class='fa fa-photo'  style={{fontSize:"40px",color:"purple"}}></i>
            ...
            <h3 ><a href='/Likedimages'> Liked Images</a> </h3>
            <p class="lead mb-0" style={{fontWeight:'bold'}}>Your Liked Images</p>
          </div>
        </div>
