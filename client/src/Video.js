...
<div class="col-lg-2">	<button class='btn btn-info'>Name</button></div><div class="col-lg-10"><center><button class='btn btn-primary'>{res.name}</button></center></div>
		...
		<div class="features-icons-icon d-flex">		
			...
			<div class="features-icons-icon d-flex">
		 <div class="col-lg-12"><center><button  class='btn btn-secondary' id={res._id} onClick={this.fun.bind(this,res._id,this.state.username)} style={{marginRight:"15px"}}>Like</button></center></div>
			</div><br></br>
 ...
 fun=(id,name)=>{
		...
		fetch('/likeVideo',{ method: 'POST', body:JSON.stringify(data),
